        ...
        <div className="min-h-screen px-36">
            <div className="grid min-h-screen grid-cols-2 gap-3 items-center">
                ...
                <div className='flex flex-col text-right'>
                    ...
                    <input onChange={(e) => setEmail(e.target.value)} placeholder='john.doe@email.com' value={email} type="text" className='border-4 border-black rounded-xl p-2 mb-5 px-4 text-right' />
                    ...
                    <div className='flex flex-row-reverse'>
                        <button onClick={() => register(email, password)} className='px-3 p-2 border-4 border-black rounded-xl w-1/5 text-xl font-bold drop-shadow-sharp bg-white'>register</button>
                    </div>
